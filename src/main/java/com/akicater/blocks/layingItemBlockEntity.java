...
public class layingItemBlockEntity extends BlockEntity {
    ...
    public void readNbt(NbtCompound nbt) {
        ...
        if (nbt.contains("quat")) {
            QuaternionfWithCodec.CODEC1.parse(NbtOps.INSTANCE, nbt.getCompound("quat")).resultOrPartial(LOGGER::error).ifPresent(quat -> {
    ...
    public void writeNbt(NbtCompound nbt) {
        ...
        QuaternionfWithCodec.CODEC1.encodeStart(NbtOps.INSTANCE, this.quaternionf).resultOrPartial(LOGGER::error).ifPresent(
